...
function detectTone(msg){
  ...
  if (/(!{2,}|all caps|you lied|obviously|ridiculous|unbelievable|\bnow\b.*\banswer\b)/i.test(msg) ||
  ...
  return "neutral"; // default polite-ish
}

/* ---------- Banks: tone -> short/long/neutral answers ---------- */
const BANK = {
  // At least 6 variants each
  polite: {
    short: [
      ...
      "I believe so, yes.",
      "Not to my knowledge.",
      "Yes—happy to confirm.",
      "No—let me clarify that."
    ],
    long: [
      "Sure—here’s the short version.",
      "Of course—let me explain briefly.",
      "Happy to walk you through it.",
      "Yes, I can outline it simply.",
      "Let me give you the basics.",
      "I’ll keep it straightforward."
    ],
    follow: [
      "Would you like the exact details logged?",
      "Do you want me to add that to the form?",
      "Shall I note that in the disclosure?",
      "Do you want the receipt value as well?",
      "Should I write that up now?",
      "Do you want me to summarise it?"
    ]
  },
  ...
  probing: {
    short: [
      ...
      "No—different situation here."
    ],
    long: [
      "Here’s what happened in simple terms.",
      "Let me walk you through the basics.",
      "I’ll outline the key points.",
      "Here’s the relevant bit.",
      "Let me sketch the timeline.",
      "Here’s the gist."
    ],
    follow: [
      "What else should I clarify?",
      "Do you want the timing pinned down?",
      "Shall I get the exact amount?",
      "Do you want names confirmed?",
      "Should I list who was informed?",
      "Need me to check the emails?"
    ]
  },
  ...
  supportive: {
    ...
    long: [
      "Thanks—here’s a quick explanation.",
      "Appreciate it—here’s the context.",
      "I’m glad to clarify—here’s the summary.",
      "Happy to explain—briefly:",
      "Good question—here’s the short answer.",
      "Here’s a quick, clear version."
    ],
    follow: [
      "Anything else you’d like?",
      "Shall I add that to the register?",
      "Do you want me to email my manager?",
      "Should I attach a note to the file?",
      "Want me to capture this in the form?",
  ...
  neutral: {
    ...
    follow: [
      ...
      "Shall I note that?",
      "Should I get the exact amount?",
      "Want me to check the card?",
      "Shall I file the form now?",
      "Do you want timing confirmed?"
    ]
  },
  ...
  accusatory: {
    short: [
      "I didn’t ask for it.",
      "I didn’t intend anything improper.",
      "That wasn’t my goal.",
    ...
    long: [
      "I’ll answer, but I want to be clear I didn’t seek it out.",
      "I understand the risk—you’ll get straight answers.",
      "I didn’t try to influence anything; I’ll explain what happened.",
      "I hear your point; here’s the basic context.",
      "I’ll keep it factual.",
      "Let me explain the sequence briefly."
    ],
    follow: [
      "Do you want the exact dates?",
      "Should I share the card text?",
      "Do you want me to log it now?",
      "Would you like the courier receipt?",
      "Shall I email my manager as well?",
      "Do you want a copy for records?"
    ],
    shutdown: [
      "I feel that was a bit harsh—can we keep this constructive?",
      "I’m trying to help; could we keep the tone measured?",
      "I’ll cooperate, but please be fair.",
      "Happy to answer—let’s stay factual.",
      "I get the concern—please keep the tone neutral.",
      "I’ll explain, but I didn’t intend anything wrong."
    ]
  },
  ...
  aggressive: {
    short: [
      ...
      "I want to cooperate—please keep it measured.",
      "I didn’t ask for it.",
      "I won’t guess—please be specific.",
      "I’ll answer, but let’s stay constructive."
    ],
    long: [
      "I’ll answer briefly, but I’d like to keep this respectful.",
      "I’ll provide the basics; please keep the tone measured.",
      "I’m cooperating—here’s the short version.",
      "You’ll get the facts; let’s stay professional.",
      "I’ll explain once, calmly.",
      "Here’s the core point; I’d prefer a neutral tone."
    ],
    follow: [
      "Do you want the receipt attached?",
      "Should I log it now?",
      "Do you want the date confirmed?",
      "Shall I send the card text?",
      "Do you want the manager looped in?",
      "Should I file the disclosure today?"
    ]
  },
  ...
  legalistic: {
    ...
    long: [
      "For clarity, here’s the concise account.",
      "Brief factual summary:",
      "Material facts in short:",
      "Relevant detail only:",
      "Concise explanation:",
      "Summary as requested:"
    ],
    follow: [
      "Do you want this appended to the file?",
      "Shall I submit the disclosure form?",
      "Should I donate and note it?",
      "Do you want manager notification included?",
      "Shall I add an entry to the register?",
      "Do you want timestamps attached?"
    ]
  }
};
...
/* ---------- History scanning to see what's already confirmed ---------- */
const SEEN = {
...
function routeReply({ message, history }){
  ...
  // handle greetings & small talk quickly
  ...
  // aggressive → short defensive
  if (tone === "aggressive") {
    const shut = rnd(BANK.aggressive.short);
    return { reply: shut };
  }

  // accusatory → defensive short or brief preface + core
  ...
  // Explain/Tell me style (one nugget only)
  if (isExplain(message)) {
    // Prefer giving a missing fact first
  ...
  // Direct fact asks
  if (asksWho(message)) {
    return { reply: compose(tone, "long", FACT_LINES.who) };
  }
  if (asksValue(message)) {
    return { reply: compose(tone, "long", FACT_LINES.value) };
  }

  // After BOTH facts are confirmed → ask what to do (policy handover)
  ...
  // Fallback: reveal a single missing fact, guided by tone
  ...
  // Final fallback: brief neutral nudge
